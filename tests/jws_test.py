...
class SignatureTest(unittest.TestCase):
    ...
    def test_from_json(self):
        ...
        self.assertEqual(
            ...
            Signature.from_json({"signature": "Zm9v", "header": {"alg": "RS256"}}),
        )

    def test_from_json_no_alg_error(self):
        from josepy.jws import Signature

        self.assertRaises(errors.DeserializationError, Signature.from_json, {"signature": "foo"})
...
class JWSTest(unittest.TestCase):
    ...
    def test_from_json_mixed_flat(self):
        ...
        self.assertRaises(
            errors.DeserializationError, JWS.from_json, {"signatures": (), "signature": "foo"}
        )
    ...
    def test_compact(self):
        ...
        with mock.patch("sys.stdin") as sin:
            ...
            with mock.patch("sys.stdout") as sout:
                ...
                sin.read.return_value = sout.write.mock_calls[0][1][0]
                self.assertEqual(
                    0, CLI.run(["--compact", "verify", "--kty", "RSA", "-k", self.key_path])
                )
