...
class JWKRSATest(unittest.TestCase, JWKTestBaseMixin):
    ...
    def test_load(self):
        ...
        self.assertEqual(self.private, JWKRSA.load(test_util.load_vector("rsa256_key.pem")))
    ...
    def test_from_json_non_schema_errors(self):
        ...
        self.assertRaises(
            errors.DeserializationError, JWK.from_json, {"kty": "RSA", "e": "AQAB", "n": ""}
        )
        self.assertRaises(
            errors.DeserializationError, JWK.from_json, {"kty": "RSA", "e": "AQAB", "n": "1"}
        )
...
class JWKECTest(unittest.TestCase, JWKTestBaseMixin):
    ...
    def test_load(self):
        ...
        self.assertEqual(self.private, JWKEC.load(test_util.load_vector("ec_p256_key.pem")))
